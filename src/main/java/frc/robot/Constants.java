...
public final class Constants {
    ...
    public static class SwerveDrive {
        ...
        public static final double TICKS_PER_RADIAN_ANGLE = SwerveModule.GEAR_RATIO * TICKS_IN_ENCODER / (2 * Math.PI); // ticks per radian. [ticks/rad]
        public static final double TICKS_PER_METER_DRIVE = SwerveModule.GEAR_RATIO * TICKS_IN_ENCODER / (2 * Math.PI * WHEEL_RADIUS); // ticks per meter. [ticks/m]
        ...
        public static final double MAX_ROTATIONAL_VELOCITY = 4.5; // maximum velocity of the modules. [m/s]
