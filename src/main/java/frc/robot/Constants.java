...
public final class Constants {
    ...
    public static class SwerveDrive {
        ...
        public static final double[] fl_anglePID = new double[]{0, 0, 0, 0}; // front left PID controller for angle.
        public static final double[] fr_anglePID = new double[]{0, 0, 0, 0}; // front right PID controller for angle.
        public static final double[] rl_anglePID = new double[]{0, 0, 0, 0}; // rear left PID controller for angle.
        public static final double[] rr_anglePID = new double[]{0, 0, 0, 0}; // rear right PID controller for angle.
        ...
        public static final double[] fl_drivePID = new double[]{0, 0, 0, 0}; // front left PID controller for drive.
        public static final double[] fr_drivePID = new double[]{0, 0, 0, 0}; // front right PID controller for drive.
        public static final double[] rl_drivePID = new double[]{0, 0, 0, 0}; // rear left PID controller for drive.
        public static final double[] rr_drivePID = new double[]{0, 0, 0, 0}; // rear right PID controller for drive.
        ...
        public static final double TICKS_IN_ENCODER_ANGLE = 1024;
        public static final double TICKS_IN_ENCODER_DRIVE = 1024;
        public static final double TICKS_PER_DEGREE_ANGLE = SwerveModule.GEAR_RATIO_ANGLE * TICKS_IN_ENCODER_ANGLE / 360; // ticks per degree. [ticks/deg]
        public static final double TICKS_PER_METER_DRIVE = SwerveModule.GEAR_RATIO_DRIVE * TICKS_IN_ENCODER_DRIVE / (2 * Math.PI * WHEEL_RADIUS); // ticks per meter. [ticks/m]
        ...
        public static final double MAX_ROTATIONAL_VELOCITY = 4.5; // maximum rotational velocity of the robot. [rad/s]

        public static final double DEADBAND = 0.02; // deadband for the joysticks.
